...
const QMetaObject SeleccioSimple::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SeleccioSimple.data,
      qt_meta_data_SeleccioSimple,  qt_static_metacall, nullptr, nullptr}
};
...
void *SeleccioSimple::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SeleccioSimple.stringdata0))
        return static_cast<void*>(const_cast< SeleccioSimple*>(this));
    if (!strcmp(_clname, "Plugin"))
        return static_cast< Plugin*>(const_cast< SeleccioSimple*>(this));
