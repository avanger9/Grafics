...
const QMetaObject Show_degree::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Show_degree.data,
      qt_meta_data_Show_degree,  qt_static_metacall, nullptr, nullptr}
};
...
void *Show_degree::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Show_degree.stringdata0))
        return static_cast<void*>(const_cast< Show_degree*>(this));
    if (!strcmp(_clname, "Plugin"))
        return static_cast< Plugin*>(const_cast< Show_degree*>(this));
...
static const unsigned char qt_pluginMetaData[] = {
    ...
    'a',  's',  's',  'N',  'a',  'm',  'e',  0x00,
    0x0b, 0x00, 'S',  'h',  'o',  'w',  '_',  'd', 
    'e',  'g',  'r',  'e',  'e',  0x00, 0x00, 0x00,
